...
RSpec.describe ProGrammar::Config::Value do
  describe "#call" do
    context "when given value is a MemoizedValue" do
      subject { described_class.new(ProGrammar::Config::MemoizedValue.new { 123 }) }
    ...
    context "when given value is a LazyValue" do
      subject { described_class.new(ProGrammar::Config::LazyValue.new { 123 }) }
