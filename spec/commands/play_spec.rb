...
describe "play" do
  ...
  describe "with an argument" do
    ...
    describe "implied file" do
      ...
      # describe "integer" do
      #   it "should process one line from pro_grammar_instance.last_file" do
      ...
      # describe "range" do
      #   it "should process multiple lines at once from pro_grammar_instance.last_file" do
  ...
  describe "whatever" do
    ...
    it 'has pretty error messages when -d cant find object' do
      expect { @t.process_command "play -d sdfsdf" }
        .to raise_error(ProGrammar::CommandError, /Cannot locate/)
    end
    ...
    describe "play -i" do
      it 'should play multi-ranged input expressions' do
        ...
        redirect_pro_grammar_io(
          ...
          binding.pro_grammar # rubocop:disable Lint/Debugger
        end
