...
describe ProGrammar::Command::ShellCommand do
  describe 'cd' do
    before do
      @o = Object.new
      ...
      @t = pro_grammar_tester(@o) do
        def command_state
          ProGrammar::CommandState.default.state_for(ProGrammar::Command::ShellCommand.match)
        end
      end
    end

    after { ProGrammar::CommandState.default.reset(ProGrammar::Command::ShellCommand.match) }
    ...
    describe ".cd" do
      ...
      describe "given a dash" do
        ...
        describe "given a prior directory" do
          it "sends the user's last pro_grammar working directory to File.expand_path" do
