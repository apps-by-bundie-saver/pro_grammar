...
describe ProGrammar::Method::Patcher do
  # rubocop:disable Style/SingleLineMethods
  before do
    @x = Object.new
    def @x.test; :before; end
    @method = ProGrammar::Method(@x.method(:test))
  end
  ...
  it "should change the source of new ProGrammar::Method objects" do
    @method.redefine "def @x.test; :after; end\n"
    expect(ProGrammar::Method(@x.method(:test)).source.strip).to eq "def @x.test; :after; end"
  end
  ...
  it "should preserve visibility" do
    ...
    @method.redefine "def @x.test; :after; end\n"
    expect(ProGrammar::Method(@x.method(:test)).visibility).to eq :private
  end
end
