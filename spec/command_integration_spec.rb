...
describe "commands" do
  before do
    ...
    @bs1 = "Pad.bs1 = pro_grammar_instance.binding_stack.dup"
    @bs2 = "Pad.bs2 = pro_grammar_instance.binding_stack.dup"
    @bs3 = "Pad.bs3 = pro_grammar_instance.binding_stack.dup"

    @self = "Pad.self = self"

    @command_tester = ProGrammar::CommandSet.new do
  ...
  describe "alias_command" do
    it 'should make an aliasd command behave like its original' do
      ...
      pro_grammar_tester(commands: set).tap do |t|
    ...
    it 'should pass on arguments to original' do
      ...
      t = pro_grammar_tester(commands: set)
    ...
    it 'should pass option arguments to original' do
      ...
      obj = Class.new { @x = 10 }
      t = pro_grammar_tester(obj, commands: set)
    ...
    it 'should be able to make the alias a regex' do
      ...
      redirect_pro_grammar_io(InputTester.new("test-alias"), out1 = StringIO.new) do
        ProGrammar.start self, commands: set
      end
  ...
  describe "ProGrammar::Command#run" do
    it 'should allow running of commands with following whitespace' do
      ...
      redirect_pro_grammar_io(InputTester.new("cd 1/2/3/4/5/6", @bs1, "test-run",
                                      @self, @bs2, "exit-all")) do
        ProGrammar.start(@o, commands: set)
      end
    ...
    it 'should run a command from within a command' do
      klass = ProGrammar::CommandSet.new do
        command "v" do
      ...
      expect(pro_grammar_tester(commands: klass).eval('run_v')).to match(/v command/)
    end
    ...
    it 'should run a regex command from within a command' do
      ...
      expect(pro_grammar_tester(commands: klass).eval('run_v')).to match(/v baby/)
    end
    ...
    it 'should run a command from within a command with arguments' do
      ...
      %w[run_v_explicit_parameter run_v_embedded_parameter].each do |cmd|
        expect(pro_grammar_tester(commands: klass).eval(cmd)).to match(/v baby param/)
      end
    end
  end
  ...
  describe "ProGrammar#run_command" do
    it 'should run a command that modifies the passed in eval_string' do
      p = ProGrammar.new(output: @str_output)
      p.eval "def hello\npeter pan\n"
    ...
    it 'should run a command in the context of a session' do
      pro_grammar_tester(Object.new).tap do |t|
        t.eval "@session_ivar = 10", "pro_grammar_instance.run_command('ls')"
  ...
  it 'should interpolate ruby code into commands' do
    ...
    expect(pro_grammar_tester(commands: set).eval('hello #{Pad.bong}')).to match(/bong/)
    # rubocop:enable Lint/InterpolationCheck
  end

  # bug fix for https://github.com/pro_grammar/pro_grammar/issues/170
  it(
  ...
  it 'should NOT interpolate ruby code into commands if :interpolate => false' do
    ...
    # rubocop:disable Lint/InterpolationCheck
    expect(pro_grammar_tester(commands: set).eval('hello #{Pad.bong}'))
      .to match(/Pad\.bong/)
    # rubocop:enable Lint/InterpolationCheck
  end
  ...
  it 'should NOT try to interpolate pure ruby code (no commands) ' do
    ...
    expect { pro_grammar_eval 'raise \'#{aggy}\'' }.to raise_error RuntimeError
    expect { pro_grammar_eval 'raise #{aggy}' }.to raise_error RuntimeError
    expect(pro_grammar_eval('format \'#{my_var}\'')).to eq "\#{my_var}"
    # rubocop:enable Lint/InterpolationCheck
  end
  ...
  it 'should create a command with a space in its name zzz' do
    ...
    expect(pro_grammar_tester(commands: set).eval('hello baby'))
  ...
  it 'should create a command with a space in its name and pass an argument' do
    ...
    expect(pro_grammar_tester(commands: set).eval('hello baby john'))
  ...
  it 'should create a regex command and be able to invoke it' do
    ...
    expect(pro_grammar_tester(commands: set).eval('hello1')).to match(/hello1/)
  end
  ...
  it(
    ...
    expect(pro_grammar_tester(commands: set).eval('hello1 baby')).to match(/hello 1 baby/)
  end
  ...
  it 'should create a regex command and interpolate the captures' do
    ...
    bong = "bong"
    expect(pro_grammar_tester(binding, commands: set).eval("hello #{bong}"))
      .to match(/hello #{bong}/)
  end
  ...
  it 'should create a regex command and arg_string should be interpolated' do
    ...
    expect(pro_grammar_tester(binding, commands: set)
  ...
  it 'if a regex capture is missing it should be nil' do
    ...
    expect(pro_grammar_tester(commands: set).eval('hello baby')).to match(/hello nil baby/)
  end
  ...
  it(
    ...
    tester = pro_grammar_tester(Object.new)
    expect(tester.eval(*<<-RUBY.split("\n"))).to match(/instance variables:\s+@x/m)
      @x = nil
      cd 7
      pro_grammar_instance.commands.instance_eval { command('bing') { |arg| run arg } }
      cd ..
      bing ls
    RUBY
  end
  ...
  it 'should define a command that keeps its return value' do
    ...
    t = pro_grammar_tester(commands: klass)
    t.eval("hello\n")
  ...
  it 'should define a command that does NOT keep its return value' do
    ...
    t = pro_grammar_tester(commands: klass)
    expect(t.eval("hello\n")).to eq ''
    expect(t.last_command_result).to eq ProGrammar::Command::VOID_VALUE
  end
  ...
  it(
    ...
    expect(pro_grammar_tester(commands: klass).eval("hello\n").empty?).to eq true
  end
  ...
  it(
    ...
    redirect_pro_grammar_io(InputTester.new('def yo', 'hello'), @str_output) do
      ProGrammar.start self, commands: klass
    end
  ...
  it(
    ...
    expect(pro_grammar_tester(commands: klass).eval("def yo", "hello")).to eq 7
  end
  ...
  it(
    ...
    expect(pro_grammar_tester(commands: klass).eval("def yo", "hello\n")).to eq 5
  end
  ...
  it 'should set the commands default, and the default should be overridable' do
    ...
    other_klass = ProGrammar::CommandSet.new do
      command "goodbye", "" do
        output.puts "goodbye world"
      end
    end

    ProGrammar.config.commands = klass
    expect(pro_grammar_tester.eval("hello")).to eq "hello world\n"
    expect(pro_grammar_tester(commands: other_klass).eval("goodbye")).to eq "goodbye world\n"
  end

  it 'should inherit commands from ProGrammar::Commands' do
    klass = ProGrammar::CommandSet.new ProGrammar::Commands do
      command "v" do
      end
    end
  ...
  it(
    ...
    child_klass = ProGrammar::CommandSet.new klass do
    end

    mock_pro_grammar(ProGrammar.binding_for('john'), "v", print: proc {}, commands: child_klass,
                                           output: @str_output)
  ...
  it 'should import commands from another command object' do
    klass = ProGrammar::CommandSet.new do
      import_from ProGrammar::Commands, "ls", "jump-to"
    end
  ...
  it 'should run a command with no parameter' do
    expect(pro_grammar_tester(commands: @command_tester).eval('command1'))
      .to eq "command1\n"
  end

  it 'should run a command with one parameter' do
    expect(pro_grammar_tester(commands: @command_tester).eval('command2 horsey'))
      .to eq "horsey\n"
  end
end
