...
class ProGrammar
  ...
  # from exiting ProGrammar when they want to.
  module RescuableException
    def self.===(exception)
      ...
      when Interrupt
        ...
        # to be intended for pro_grammar itself. We should also make sure that
        # Kernel#exit works.
      when *ProGrammar.config.unrescued_exceptions
        false
  ...
  # An Exception Tag (cf. Exceptional Ruby) that instructs ProGrammar to show the error
  # in a more user-friendly manner. This should be used when the exception
  # happens within ProGrammar itself as a direct consequence of the user typing
  # something wrong.
  #
  # This allows us to distinguish between the user typing:
  #
  # pro_grammar(main)> def )
  # SyntaxError: unexpected )
  #
  # pro_grammar(main)> method_that_evals("def )")
