...
class ProGrammar
  ...
  # @see https://github.com/pro_grammar/pro_grammar/wiki/State-navigation
  class ObjectPath
      ...
      loop do
        begin
          ...
          when ".."
            ...
            stack.push(ProGrammar.binding_for(stack.last.eval(next_segment)))
          end
    ...
    def complete?(segment)
      SPECIAL_TERMS.include?(segment) || ProGrammar::Code.complete_expression?(segment)
    end
