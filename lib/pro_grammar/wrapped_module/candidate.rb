...
class ProGrammar
  class WrappedModule
    ...
    class Candidate
      ...
      include ProGrammar::CodeObject::Helpers
      ...
      # Methods to delegate to associated `ProGrammar::WrappedModule
      # instance`.
      ...
      # @raise [ProGrammar::CommandError] If `rank` is out of bounds.
      # @param [ProGrammar::WrappedModule] wrapper The associated
      #   `ProGrammar::WrappedModule` instance that owns the candidates.
      ...
      #   `ProGrammar::WrappedModule#number_of_candidates() - 1`
      ...
      # @raise [ProGrammar::CommandError] If source code cannot be found.
      ...
      def source
        ...
        @source ||= strip_leading_whitespace(
          ProGrammar::Code.from_file(file).expression_at(line, number_of_lines_in_first_chunk)
        )
      end
      ...
      def doc
        ...
        @doc ||= get_comment_content(ProGrammar::Code.from_file(file).comment_describing(line))
      end
