...
#
# {ProGrammar::LastException} is a proxy class who wraps an Exception object for
# {ProGrammar#last_exception}. it extends the exception object with methods that
# help pro_grammar commands be useful.
#
