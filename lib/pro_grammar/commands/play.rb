...
class ProGrammar
  class Command
    class Play < ProGrammar::ClassCommand
      match 'play'
      group 'Editing'
      ...
      banner <<-'BANNER'
        ...
        were entered directly in the ProGrammar REPL.
        ...
        play ProGrammar#repl -l 1..-1  # play the contents of ProGrammar#repl method
        ...
        https://github.com/pro_grammar/pro_grammar/wiki/User-Input#wiki-Play
      BANNER
      ...
      def process
        @cc = CodeCollector.new(args, opts, pro_grammar_instance)
      ...
      def show_input
        ...
        return unless ProGrammar::Code.complete_expression?(eval_string)
    ...
    ProGrammar::Commands.add_command(ProGrammar::Command::Play)
  end
end
