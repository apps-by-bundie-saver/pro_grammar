...
class ProGrammar
  class Command
    class FindMethod < ProGrammar::ClassCommand
      ...
      banner <<-'BANNER'
        ...
        # the ProGrammar namespace. Matches ProGrammar#repl, etc.
        find-method re ProGrammar

        # Find all methods that contain the code:
        # output.puts inside the ProGrammar namespace.
        find-method -c 'output.puts' ProGrammar
      BANNER
      ...
      def search_all_methods(namespace)
        ...
        recurse_namespace(namespace) do |klass|
          methods = ProGrammar::Method.all_from_class(klass) + ProGrammar::Method.all_from_obj(klass)
    ...
    ProGrammar::Commands.add_command(ProGrammar::Command::FindMethod)
  end
end
