  ...
  class Command
    class ShowDoc < Command::ShowInfo
      ...
      banner <<-BANNER
        ...
        show-doc ProGrammar       # for ProGrammar class
        show-doc ProGrammar -a    # for all definitions of ProGrammar class (all monkey patches)
      BANNER
    ...
    ProGrammar::Commands.add_command(ProGrammar::Command::ShowDoc)
    ProGrammar::Commands.alias_command '?', 'show-doc'
  end
end
