...
class ProGrammar
  class Command
    class ReloadCode < ProGrammar::ClassCommand
      match 'reload-code'
      group 'Misc'
      ...
      banner <<-'BANNER'
        ...
        e.g reload-code MyClass#my_method    #=> reload a method
            ...
            reload-code my-command           #=> reload a pro_grammar command
      ...
      def reload_object(identifier)
        code_object = ProGrammar::CodeObject.lookup(identifier, pro_grammar_instance)
    ...
    ProGrammar::Commands.add_command(ProGrammar::Command::ReloadCode)
    ProGrammar::Commands.alias_command 'reload-method', 'reload-code'
  end
end
