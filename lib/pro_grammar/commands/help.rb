...
class ProGrammar
  class Command
    class Help < ProGrammar::ClassCommand
      match 'help'
      group 'Help'
      ...
      def display_index(groups)
        ...
        pro_grammar_instance.pager.page help_text.join("\n\n")
      end
      ...
      # @param [Array<ProGrammar::Command>] commands
      ...
      #
      # @param [Array<ProGrammar::Command>] commands The commands to sort
      # @return [Array<ProGrammar::Command>] commands sorted by listing name.
      ...
      def display_command(command)
        pro_grammar_instance.pager.page command.new.help
      end
      ...
      # @return [String]
      def normalize(key)
        key.downcase.gsub(/pro_grammar\W+/, '')
      end

      def group_sort_key(group_name)
        [
          %w[
            Help Context Editing Introspection Input_and_output Navigating_pro_grammar
            Gems Basic Commands
    ...
    ProGrammar::Commands.add_command(ProGrammar::Command::Help)
  end
end
