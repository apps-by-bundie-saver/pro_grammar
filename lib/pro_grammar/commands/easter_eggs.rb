...
class ProGrammar
  ProGrammar::Commands.instance_eval do
  ...
  Intellectual orgy of feeling life!
    ...
    command "test-ansi", "" do
      prev_color = pro_grammar_instance.config.color
      pro_grammar_instance.config.color = true
      ...
      pro_grammar_instance.config.color = prev_color
    end
  end
end
