...
class ProGrammar
  class Command
    class ShowSource < Command::ShowInfo
      include ProGrammar::Helpers::DocumentationHelpers
      ...
      banner <<-'BANNER'
        ...
        show-source hi_method
        show-source ProGrammar#rep     # source for ProGrammar#rep method
        show-source ProGrammar         # for ProGrammar class
        show-source ProGrammar -a      # for all ProGrammar class definitions (all monkey patches)
        show-source ProGrammar.foo -e  # for class of the return value of expression `ProGrammar.foo`
        show-source ProGrammar --super # for superclass of ProGrammar (Object class)
        show-source ProGrammar -d      # include documentation

        https://github.com/pro_grammar/pro_grammar/wiki/Source-browsing#wiki-Show_method
      BANNER
    ...
    ProGrammar::Commands.add_command(ProGrammar::Command::ShowSource)
    ProGrammar::Commands.alias_command 'show-method', 'show-source'
    ProGrammar::Commands.alias_command '$', 'show-source'
  end
end
