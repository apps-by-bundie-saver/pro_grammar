...
class ProGrammar
  class Command
    class Ri < ProGrammar::ClassCommand
      match 'ri'
      group 'Introspection'
      ...
      def process(spec)
        ...
        unless defined? RDoc::RI::ProGrammarDriver
          ...
          RDoc::RI.const_set :ProGrammarDriver, subclass # hook it up!
        end

        # Spin-up an RI insance.
        ri = RDoc::RI::ProGrammarDriver.new(
          pro_grammar_instance.pager, use_stdout: true, interactive: false
        )
    ...
    ProGrammar::Commands.add_command(ProGrammar::Command::Ri)
  end
end
