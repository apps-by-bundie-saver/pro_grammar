...
class ProGrammar
  ##
  # ProGrammar::Indent is a class that can be used to indent a number of lines
  ...
  class Indent
    ...
    def initialize(pro_grammar_instance = ProGrammar.new)
    ...
    #  # end
    #  #
    #  puts ProGrammar::Indent.new.indent(str)
    #
    ...
    #
    # This is what's used between the prompt and the cursor in pro_grammar.
    #
    ...
    def correct_indentation(prompt, code, overhang = 0)
      ...
      line_to_measure = ProGrammar::Helpers::Text.strip_color(prompt) << code
      whitespace = ' ' * overhang

      cols = @pro_grammar_instance.output.width
